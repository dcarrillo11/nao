...
[docs]async def test_get_device_by_name():
...
[docs]async def test_get_device_list():
    """Search all devices
...
[docs]async def test_connect(dev: WiFiDevice) -> bool:
    """Connect the device
...
[docs]async def test_start_run_program():
