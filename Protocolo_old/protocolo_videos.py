...
while video.isOpened():
    ...
    if cv2.waitKey(1) == 27: #Code for ESC key
        break
...
n_rep = 45 #Número de repeticiones de imaginar-ejecución
...
# Agregamos 15 "izquierdo", 15 "derecho" y 15 "ambos" aleatoriamente
...
#relax
relax_time = 10
reproducir_audio('E:/gNeC/audios/hola_relaja.mp3')
...
time.sleep(5)
reproducir_audio('E:/gNeC/audios/ahora_imagina.mp3')
time.sleep(5)
